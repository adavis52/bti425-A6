...
export default function Home() {
  return (
    <>
      <MainNav></MainNav>
      <Image fluid rounded src='https://upload.wikimedia.org/wikipedia/commons/3/30/Metropolitan_Museum_of_Art_%28The_Met%29_-_Central_Park%2C_NYC.jpg'></Image>
      ...
      <Row>
        ...
        <Col lg={6} md={12}>
          ...
          <a href="https://en.wikipedia.org/wiki/Metropolitan_Museum_of_Art" target="_blank" rel="noreferrer">Cover Image</a>
        </Col>
      </Row>
    </>
  )
